...
├── data/               # Metadata và mô tả datasets
├── report/             # Báo cáo cho từng lab
├── Lab1-6/             # Thư mục chứa code, data, results của các lab
├── README.md           # Giới thiệu tổng quan về project
└── .gitignore          # Loại bỏ các tệp không quan trọng hoặc quá lớn
```
...
- **Báo cáo:** lab3_part1.md

##### Phần 2: Word2Vec và training embeddings

- **Báo cáo:** lab3_part2.md

- **Dataset:** GloVe, UD English-EWT, C4
